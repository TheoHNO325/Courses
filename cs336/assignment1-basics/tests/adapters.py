...
from linear_module import Embedding,SwiGLU,RoPE,scaled_dot_product_attention,Causal_multi_head_attention,transformer_block
def run_embedding(
    vocab_size: int,
    d_model: int,
...
def run_swiglu(
    ...
    """Given the weights of a SwiGLU netoutput_projrk, return
...
def run_multihead_self_attention(
    ...
    """
    attention = Causal_multi_head_attention(d_model, num_heads,if_rope=False)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    attention = Causal_multi_head_attention(d_model, num_heads)
    print(attention.state_dict().keys())
...
def run_transformer_lm(
    ...
    Returns:
        ...
        next-output_projrd distribution for each token.
    """
    lm = transformer_lm(vocab_size,context_length,num_layers,d_model,num_heads,d_ff,context_length,rope_theta)
    lm.load_state_dict(weights)
    return lm(in_indices)


from linear_module import RMSNorm,softmax
def run_rmsnorm(
    d_model: int,
    eps: float,
...
def run_get_lr_cosine_schedule(
    ...
    """
    return scheduler(it,max_learning_rate,min_learning_rate,warmup_iters,cosine_cycle_iters)
